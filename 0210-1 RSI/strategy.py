...
class Config:
    ...
    # 參數範圍 (用於 ACO 探索)
    # S_H: 最大持倉檔數
    # P_BAR: 20日內創50天新高次數門檻
    # BIAS_60_MAX: 60日乖離率上限 (%)
    # EXIT_MA: 出場均線天數
    PARAM_RANGES = {
        'S_H': [3, 4, 5, 8, 10],
        'P_BAR': [1, 2, 3, 5, 8, 10, 15],
        'BIAS_60_MAX': [5, 10, 15, 20, 25, 30],
        'EXIT_MA': [5, 10, 20, 60]
    }
...
class Strategy:
    ...
    def _calculate_indicators(self):
        ...
        # 計算20日內次數 (rolling sum)
        self.indicators['count_high_50'] = is_high_50.rolling(window=20, min_periods=20).sum()
