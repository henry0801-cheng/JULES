...
class Strategy:
    def __init__(self, data_file, n_days, top_k, v_bar, trail_stop, stop_sma_window, data=None):
        """
        初始化策略
        ...
        :param stop_sma_window: 停損 SMA 均線天數
    ...
    def run_backtest(self):
        ...
        for i in range(len(dates)):
            ...
            for ticker in current_held_tickers:
                ...
                # Stop 2: SMA Stop
                # 股價跌破 STOP_SMA
                sma_val = sma_stop.loc[today, ticker] if ticker in sma_stop.columns else np.nan
